...
describe('Auth Service', () => {
    ...
    beforeEach(async () => {
        ...
        boilerPartsService =
            testModule.get<BoilerPartsService>(BoilerPartsService);
    ...
    it('should find by name', async () => {
        const part = await boilerPartsService.findOneByName('Amet explicabo.');
    ...
    it('should find new parts', async () => {
        const parts = await boilerPartsService.newProducts();
